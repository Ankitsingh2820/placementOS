...
async def lifespan(app: FastAPI):
    ...
    async def _loop():
        # Initial load runs in the background so startup (and health checks) aren't blocked
        # while boards are fetched/translated. /jobs returns [] until the first load completes.
        await refresh_feed()
        while True:
